...
function PWork() {
    return (
         ...
         <div className="mx-auto col-start-1 row-start-1 bg-black rounded-lg lg:px-16 xl:px-24 py-4 px-4 grid grid-flow-col grid-cols-1  ">
             <a target="_blank" rel="noopener noreferrer" href="https://agitated-benz-13e173.netlify.app/" >
                                            <div  className="mx-auto col-start-1  row-start-1 ">
                                                ...
                                                <h1 className="text-white text-lg font-sans hover:text-aqua">Front end: JavaScript, React, HTML and Tailwindcss</h1>
                                                </div>
                                                </a>
                                            ...
                                            <div className=" mt-2 sm:mt-0 mx-auto col-start-1 lg:col-start-1 row-start-3 lg:row-start-2 bg-black rounded-lg px-4 lg:px-16 xl:px-24 py-4  grid grid-flow-col grid-cols-1  hover:text-aqua  ">
                                            <a target="_blank" rel="noopener noreferrer" href="https://trusting-albattani-fdc343.netlify.app/">
                                            <div  className="mx-auto col-start-1  row-start-1">
        ...
        <div className=" mt-2 sm:mt-0 mx-auto col-start-1 lg:col-start-2 row-start-4 lg:row-start-2 bg-black rounded-lg px-4 lg:px-16 xl:px-24 py-4  grid grid-flow-col grid-cols-1  hover:text-aqua  ">
                                            <a target="_blank" rel="noopener noreferrer" href="https://trusting-albattani-fdc343.netlify.app/">
                                            <div  className="mx-auto col-start-1  row-start-1">
