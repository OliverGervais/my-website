...
function Skills() {
    const props = useSpring({opacity: 1,marginRight: 0, from: {opacity: 0, marginRight: -500 } ,delay:2250 ,config:{duration: 1000} })
        ...
        <div className=" bg-black rounded-lg md:p-4 mb-2  lg:mx-36   mt-2 grid grid-flow-col grid-cols-1  grid-rows-2 sm:grid-cols-2 sm:grid-rows-1    bg-opacity-90">
                                        ...
                                        <div className="mx-auto col-start-1 row-start-1 bg-black rounded-lg px-24 sm:px-16 py-4 grid grid-flow-col grid-cols-1 ">
                                            <div  className="mx-auto col-start-1  row-start-1">
                                                ...
                                                <img className="animate-pulse w-32" src="frontend_icon.svg" alt="Passionate icon"/>
                                        ...
                                        <div className=" mt-2 sm:mt-0 mx-auto col-start-1 sm:col-start-2 row-start-2 sm:row-start-1 bg-black rounded-lg  px-28 sm:px-24 py-4    grid grid-flow-col grid-cols-1  ">
                                            <div  className="mx-auto col-start-1  row-start-1"><img className="animate-pulse w-32" src="Backend_icon.svg" alt="Passionate icon"/></div>
